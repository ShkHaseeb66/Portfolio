...
if(isset($_POST['submit'])){
    ...
    $insert_query = "INSERT INTO `contacts`(`name`, `email`, `phone_number`, `message`) VALUES ('[$u_name]','[$email]','[$phone_number]','[$message]')";
                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <!-- to get an API token!-->
                                <form action="<?php $_SERVER['PHP_SELF'];?>" id="contactForm" data-sb-form-api-token="API_TOKEN" method="post">
                                    <!-- Name input-->
                                    <?php $msg
                                    ?>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="u_name" id="name" type="text" placeholder="Enter your name..." data-sb-validations="required" />
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button class="btn btn-primary btn-lg " type="submit" name="submit">Submit</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
